        ...
        <script src="<?php echo base_url('ng/controllers/admin/script.js'); ?>"></script>
        
        <script src="<?php echo base_url('ng/controllers/admin/main-controller.js'); ?>"></script>
        
        <script src="<?php echo base_url('ng/controllers/admin/student-controller.js'); ?>"></script>

        <script src="<?php echo base_url('ng/controllers/admin/staff-controller.js'); ?>"></script>
